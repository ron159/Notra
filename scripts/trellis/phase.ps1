...
switch ($Phase) {
    "00-product" {
        ...
        Write-Output "Output: local_doc/00-product.md"
    }
    "01-ui-prototype" {
        Write-Output "Goal: design the Catio/mxterm style workbench."
        Write-Output "Output: local_doc/01-ui-prototype.md"
    }
    "02-architecture" {
        Write-Output "Goal: define Rust native architecture boundaries."
        Write-Output "Output: local_doc/02-architecture.md"
    }
    "03-editor-core" {
        Write-Output "Goal: implement the editor core."
        Write-Output "Output: crates/otterdive-core"
    }
    "04-search-replace" {
        Write-Output "Goal: implement the core search and replace experience."
        Write-Output "Output: crates/otterdive-core/src/search.rs and app panel"
    }
    "05-performance" {
        Write-Output "Goal: verify performance targets."
        Write-Output "Output: local_doc/05-performance.md"
    }
    default {
